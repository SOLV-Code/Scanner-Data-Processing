...
if(!dir.exists("OUTPUT/SMU_TimelinePlotsforSOPO")){dir.create("OUTPUT/SMU_TimelinePlotsforSOPO")}
...
png(filename = paste0("OUTPUT/SMU_TimelinePlotsforSOPO/SMU_TimelinePlotforSOPO_",plot.do,".png"),
