...
if(!dir.exists("OUTPUT/SMU_TimelinePlots")){dir.create("OUTPUT/SMU_TimelinePlots")}
...
plot.specs <- read_csv("DATA_LOOKUP_FILES/SMU_TimelinePlot_Specs.csv") 
plot.specs
#view(plot.specs)
...
png(filename = paste0("OUTPUT/SMU_TimelinePlots/SMU_TimelinePlot_",plot.do,".png"),
