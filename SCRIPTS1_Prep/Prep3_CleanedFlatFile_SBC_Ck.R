...
sbc.ck.bypop.raw <- read.csv("DATA_IN/SOURCES/SBC Chinook/FlatFile_For_SalmonScanner_BySite_2023.csv",stringsAsFactors = FALSE)
...
sbc.ck.bycu.raw <- read.csv("DATA_IN/SOURCES/SBC Chinook/FlatFile_For_SalmonScanner_2023.csv",stringsAsFactors = FALSE)
