...
write.csv(fr.co.bypop.cleaned, "DATA_OUT/Cleaned_FlatFile_ByPop_FraserCoho.csv",row.names=FALSE)
...
write.csv(fr.co.bycu.cleaned, "DATA_OUT/Cleaned_FlatFile_ByCU_FraserCoho.csv",row.names=FALSE)
