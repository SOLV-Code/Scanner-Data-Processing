...
nuseds.pink <- read.csv("DATA_IN/SOURCES/Fraser Pink/FR_Pink_Conservation_Unit_Data_NUSEDs_June 2023.csv",stringsAsFactors=FALSE)
...
write.csv(Pink_CU, "DATA_PROCESSING/Cleaned_FlatFile_ByCU_FraserPink.csv")
# ------------------------------------------------------------------- #
...
write.csv(pink_pop_data,"DATA_PROCESSING/Cleaned_FlatFile_ByPop_FraserPink_All_Nuseds.csv")
